...
import com.tajy.arevagenda.basedatos.DbContactos;
import com.tajy.arevagenda.entidad.Contactos;
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txtNombre.getText().toString().equals("") &&
                    ...
                    Toast.makeText(EditarActivity.this, "¡CAMPOS OBLIGATORIOS VACÍOS!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
